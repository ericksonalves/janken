...
public class GUIConstants {
    ...
    public static final int SHAPE_HEIGHT = 120;
    ...
    public static final String SCISSORS_ICON_PATH = "resources/scissors.png";
    ...
    public static final String PLAYER_ONE_TEXT = "Jogador 1";
    public static final String PLAYER_TWO_TEXT = "Jogador 2";
    public static final String RESTART_TOOL_TIP_TEXT = "Clique para reiniciar";
    public static final String WAITING_OTHER_PLAYER_TEXT = "Esperando pelo %s";
    public static final String WINDOW_TITLE = "Janken";
